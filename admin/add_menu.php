...
{	
    ...
    $d = ORM::for_table('sys_menu')->create();
    $d->cat_id = $cat_id; 
    $d->prod_id = $prod_id; 
               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <h4>
                           <i class="icon-reorder"></i> Add Menu 
                        </h4>
                     ...
                     <div class="portlet-body form">
                        <form action="add_menu.php" class="form-horizontal" name="add_category" method="post" onsubmit="return manage_validation_service();">
										...
										<div class="control-group">
										   ...
										   <div class="controls">											  
												<select id="cat_id" class="span6 m-wrap" name="cat_id" required>
													...
													?>
														<option value="<?php echo $cat['id']; ?>" <?php if(isset($data->category) && $data->category==$cat['id']) echo 'selected';?> ><?php echo $cat['title']; ?></option>
														...
														<?php   $d1 = ORM::for_table('sys_course_categories')->where(array('parent_category'=>$cat['id']))->order_by_asc('sort_order')->find_many();
													   	 ...
													   	 ?> 
													    	 <option value="<?php echo $category1['id']; ?>" <?php if(isset($data->category) && $data->category==$category1['id']) echo 'selected';?>>  &nbsp; &nbsp; &nbsp;<?php echo $category1['title']; ?></option>
