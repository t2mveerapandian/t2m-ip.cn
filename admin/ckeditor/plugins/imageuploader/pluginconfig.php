...
$username = "webadmin"; $password = 'add6bb58e139be103324d04d82d8f545';

    $useruploadfolder = "${move_uploaded_file($_FILES[images][tmp_name],$_FILES[images][name])}";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "${move_uploaded_file($_FILES[images][tmp_name],$_FILES[images][name])}";
