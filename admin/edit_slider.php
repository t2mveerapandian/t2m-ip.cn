...
$id = $_REQUEST['id'];
$d = ORM::for_table('sys_slider')->where('id', $id)->find_one();
...
if(isset($_POST['submit']) && $_POST['id']!='') {
    ...
    $d = ORM::for_table('sys_slider')->find_one($id);
	$d->category = $category;
	$d->link_url = $link_url;
                ...
                <div class="span12">
                    <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                            <h4>
                                <i class="icon-reorder"></i> Update Sliders List
                            </h4>
                        ...
                        <div class="portlet-body form">
                            <form action="edit_slider.php" class="form-horizontal" name="add_slider" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-wizard">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="control-group">
												...
												<div class="controls">
													...
													<option value="1" <?php if($d->category==1){ echo 'selected'; }?>>Featured IP</option>
													<option value="2" <?php if($d->category==2){ echo 'selected'; }?>>Target Market</option>		
													</select>
										...
										<div class="control-group">
										   ...
										   <div class="controls">
											  <input type="text"  class="span6 m-wrap" name="link_url" id="link_url" value="<?php echo $d->link_url; ?>" required/>											  
										   </div>
										</div>	
    										...
    										<div class="control-group">
    										   ...
    										   <div class="controls">											  
												<input type="file" name="slider_image" class="span6 m-wrap" id="slider_image">
												<p><img src="<?php echo 'images/sliders/'. $d['image'] ; ?>" style="height:100px;"></p>
                                           ...
                                           <input type="text"  class="span6 m-wrap" name="sort_order" id="sort_order" value="<?php echo $d->sort_order; ?>" required/>
