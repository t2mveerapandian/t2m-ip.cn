...
$id = $_REQUEST['id'];
$d = ORM::for_table('homepagetext')->where('id', $id)->find_one();
...
if (isset($_POST['submit'])) {
    ...
    $id = $_POST['id'];
    $d = ORM::for_table('homepagetext')->find_one($id);
                ...
                <div class="span12">
                    <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                            <h4>
                                <i class="icon-reorder"></i> Update Text
                            </h4>
                        ...
                        <div class="portlet-body form">
                            <form action="edit_homePageText.php" class="form-horizontal" name="edit_homePageText" method="post" onsubmit="return manage_validation_service();">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <h3 class="block">Provide your account details</h3>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <textarea  class="span6 m-wrap ckeditor" name="description" id="description"><?php echo $d->description; ?> </textarea>
                                                    <span class="help-inline" id="event_title_error" style="display: none;">Provide Description</span>
                                                </div>
                                            </div>
