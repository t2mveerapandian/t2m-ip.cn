...
$id = $_REQUEST['id'];
$d = ORM::for_table('sys_course_categories')->find_one($id);
...
if (isset($_POST['submit'])){
    ...
    $d->title = $_POST['title'];
    $d->parent_category =  (!empty($_POST['parent_category']))   ? $_POST['parent_category']   : 0;
                ...
                <div class="span12">
                    <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                            <h4>
                                <i class="icon-reorder"></i> Update Categories List
                            </h4>
                        ...
                        <div class="portlet-body form">
                            <form action="edit_category.php" class="form-horizontal" name="add_category" method="post" onsubmit="return manage_validation_service();" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text"  class="span6 m-wrap" name="title" id="title" value="<?php echo $d->title; ?>" required/>
    										...
    										<div class="control-group">
    										   ...
    										   <div class="controls">
    												<select id="parent-category" class="span6 m-wrap" name="parent_category">
    													...
    													?>
    														<option value="<?php echo $cat['id']; ?>" <?php if($cat['id'] == $d->parent_category){echo "selected";} ?> ><?php echo $cat['title']; ?></option>
    													<?php
    													endforeach;
    													?>
    												</select>
										   ...
										   <div class="controls">
												<?php if(isset($d->cat_icon) && $d->cat_icon!=''){ ?> <img src="<?php echo 'images/icons/'.$d->cat_icon;?>" width="25px;"> <?php }?>
