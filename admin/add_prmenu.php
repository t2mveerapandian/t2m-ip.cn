...
{	
	...
	if(isset($_POST['parent_category']) && !empty($_POST['parent_category'])){
	 ...
	 {
        $slug = generateslug($_POST['slug'],'sys_prmenu','add');
	 }
	 else
	 {
	      $slug = generateslug($_POST['title'],'sys_prmenu','add');
	 }
     
  
    $d = ORM::for_table('sys_prmenu')->create();
    $d->title = $title; 
    $d->slug = $slug; 
    ...
    $d->save();
    $_SESSION['success'] = 'Parent Menu Added Successfully.';
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="manage_prmenu.php">Manage Parent Menu</a>
                        <span class="icon-angle-right"></span>
                     </li>
                     <li><a href="#">Add Parent Menu</a></li>
                  </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <h4>
                           <i class="icon-reorder"></i> Add Parrent Menu 
                        </h4>
                     ...
                     <div class="portlet-body form">
                        <form action="add_prmenu.php" class="form-horizontal" name="add_category" method="post" onsubmit="return manage_validation_service();">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab1">
										<div class="control-group">
										   ...
										   <div class="controls">
											  <input type="text"  class="span6 m-wrap" name="title" id="title"/>											  
									...
									<!--	<div class="control-group">
										   ...
										   <div class="controls">
											  <input type="text"  class="span6 m-wrap" name="slug" id="slug"/>											  
											  <span class="help-inline" id="category_title_error" style="display: none;">Provide Menu name</span>
										   </div>
										</div>-->
