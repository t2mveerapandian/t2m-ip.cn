...
<div class="col-lg-12 col-md-12 col-sm-12"> <h3>T2M Privacy Policy </h3> <div class="bor-bt" style="width:104px;"></div>

<div class="row container" style="padding-top:10px;">

<?php
$data = ORM::for_table('sys_cms')->where(array('id'=>2))->find_one();
?>
